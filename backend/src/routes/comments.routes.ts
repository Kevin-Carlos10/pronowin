...
import { authMiddleware, premiumMiddleware, premiumSaufMatchTermine } from '../middleware/auth.middleware';
...
r.get ('/:pronosticId',         authMiddleware, premiumSaufMatchTermine, C.getComments);
