...
const ACTION_LABELS = {
  ...
  '2fa_active':              { label: 'Double authentification activée',     icon: 'lock', cat: 'auth' },
  '2fa_desactive':           { label: 'Double authentification désactivée',  icon: 'lock', cat: 'auth' },
  '2fa_reinitialise':        { label: 'Double authentification réinitialisée', icon: 'lock', cat: 'admin' },
